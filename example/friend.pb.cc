...
const uint32_t TableStruct_friend_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsResponse, reuslt_),
...
const char descriptor_table_protodef_friend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "istsResponse\022\"\n\006reuslt\030\001 \001(\0132\022.fixbug.Re"
  "sultCode\022\017\n\007friends\030\002 \003(\0142]\n\020FriendServi"
  "ceRpc\022I\n\010Register\022\035.fixbug.GetFriendList"
...
const ::_pbi::DescriptorTable descriptor_table_friend_2eproto = {
    false, false, 293, descriptor_table_protodef_friend_2eproto,
    "friend.proto",
...
class GetFriendListsResponse::_Internal {
 public:
  static const ::fixbug::ResultCode& reuslt(const GetFriendListsResponse* msg);
};

const ::fixbug::ResultCode&
GetFriendListsResponse::_Internal::reuslt(const GetFriendListsResponse* msg) {
  return *msg->reuslt_;
}
...
GetFriendListsResponse::GetFriendListsResponse(const GetFriendListsResponse& from)
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  if (from._internal_has_reuslt()) {
    reuslt_ = new ::fixbug::ResultCode(*from.reuslt_);
  } else {
    reuslt_ = nullptr;
  }
...
inline void GetFriendListsResponse::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  if (this != internal_default_instance()) delete reuslt_;
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ptr = ctx->ParseMessage(_internal_mutable_reuslt(), ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* GetFriendListsResponse::_InternalSerialize(
  ...
  // .fixbug.ResultCode reuslt = 1;
  if (this->_internal_has_reuslt()) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(1, _Internal::reuslt(this),
        _Internal::reuslt(this).GetCachedSize(), target, stream);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFriendListsResponse)
  ...
  if (from._internal_has_reuslt()) {
    _internal_mutable_reuslt()->::fixbug::ResultCode::MergeFrom(from._internal_reuslt());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void FriendServiceRpc::Register(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
void FriendServiceRpc_Stub::Register(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
