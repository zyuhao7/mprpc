...
namespace mprpc
{
  PROTOBUF_CONSTEXPR RpcHeader::RpcHeader(
      ...
      : service_name_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}), method_name_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}), args_size_(0u) {}
