...
class GetFriendListsResponse final :
 ...
 public:
  ...
  // .fixbug.ResultCode reuslt = 1;
  bool has_reuslt() const;
  private:
  bool _internal_has_reuslt() const;
  public:
  void clear_reuslt();
  const ::fixbug::ResultCode& reuslt() const;
  PROTOBUF_NODISCARD ::fixbug::ResultCode* release_reuslt();
  ::fixbug::ResultCode* mutable_reuslt();
  void set_allocated_reuslt(::fixbug::ResultCode* reuslt);
  private:
  const ::fixbug::ResultCode& _internal_reuslt() const;
  ::fixbug::ResultCode* _internal_mutable_reuslt();
  public:
  void unsafe_arena_set_allocated_reuslt(
      ::fixbug::ResultCode* reuslt);
  ::fixbug::ResultCode* unsafe_arena_release_reuslt();
...
// .fixbug.ResultCode reuslt = 1;
inline bool GetFriendListsResponse::_internal_has_reuslt() const {
  return this != internal_default_instance() && reuslt_ != nullptr;
}
inline bool GetFriendListsResponse::has_reuslt() const {
  return _internal_has_reuslt();
}
inline void GetFriendListsResponse::clear_reuslt() {
  if (GetArenaForAllocation() == nullptr && reuslt_ != nullptr) {
    delete reuslt_;
  }
  reuslt_ = nullptr;
}
inline const ::fixbug::ResultCode& GetFriendListsResponse::_internal_reuslt() const {
  const ::fixbug::ResultCode* p = reuslt_;
  return p != nullptr ? *p : reinterpret_cast<const ::fixbug::ResultCode&>(
      ::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& GetFriendListsResponse::reuslt() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResponse.reuslt)
  return _internal_reuslt();
}
inline void GetFriendListsResponse::unsafe_arena_set_allocated_reuslt(
    ::fixbug::ResultCode* reuslt) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(reuslt_);
  }
  reuslt_ = reuslt;
  if (reuslt) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.GetFriendListsResponse.reuslt)
}
inline ::fixbug::ResultCode* GetFriendListsResponse::release_reuslt() {
  
  ::fixbug::ResultCode* temp = reuslt_;
  reuslt_ = nullptr;
...
inline ::fixbug::ResultCode* GetFriendListsResponse::unsafe_arena_release_reuslt() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriendListsResponse.reuslt)
  
  ::fixbug::ResultCode* temp = reuslt_;
  reuslt_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GetFriendListsResponse::_internal_mutable_reuslt() {
...
inline ::fixbug::ResultCode* GetFriendListsResponse::mutable_reuslt() {
  ::fixbug::ResultCode* _msg = _internal_mutable_reuslt();
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsResponse.reuslt)
  return _msg;
}
inline void GetFriendListsResponse::set_allocated_reuslt(::fixbug::ResultCode* reuslt) {
  ...
  if (reuslt) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(reuslt);
    if (message_arena != submessage_arena) {
      reuslt = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, reuslt, submessage_arena);
    }
  ...
  reuslt_ = reuslt;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriendListsResponse.reuslt)
}
