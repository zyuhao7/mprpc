...
namespace mprpc {
PROTOBUF_CONSTEXPR RcpHeader::RcpHeader(
...
struct RcpHeaderDefaultTypeInternal {
  PROTOBUF_CONSTEXPR RcpHeaderDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~RcpHeaderDefaultTypeInternal() {}
  union {
    RcpHeader _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 RcpHeaderDefaultTypeInternal _RcpHeader_default_instance_;
}  // namespace mprpc
...
const uint32_t TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::mprpc::RcpHeader, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::mprpc::RcpHeader, service_name_),
  PROTOBUF_FIELD_OFFSET(::mprpc::RcpHeader, method_name_),
  PROTOBUF_FIELD_OFFSET(::mprpc::RcpHeader, args_size_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::mprpc::RcpHeader)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::mprpc::_RcpHeader_default_instance_._instance,
};
...
class RcpHeader::_Internal {
 public:
};

RcpHeader::RcpHeader(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor();
  // @@protoc_insertion_point(arena_constructor:mprpc.RcpHeader)
}
RcpHeader::RcpHeader(const RcpHeader& from)
  ...
  // @@protoc_insertion_point(copy_constructor:mprpc.RcpHeader)
}

inline void RcpHeader::SharedCtor() {
service_name_.InitDefault();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  service_name_.Set("", GetArenaForAllocation());
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
RcpHeader::~RcpHeader() {
  // @@protoc_insertion_point(destructor:mprpc.RcpHeader)
...
inline void RcpHeader::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  service_name_.Destroy();
  method_name_.Destroy();
}

void RcpHeader::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}

void RcpHeader::Clear() {
// @@protoc_insertion_point(message_clear_start:mprpc.RcpHeader)
...
const char* RcpHeader::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
...
uint8_t* RcpHeader::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:mprpc.RcpHeader)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:mprpc.RcpHeader)
  return target;
}

size_t RcpHeader::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:mprpc.RcpHeader)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData RcpHeader::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    RcpHeader::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*RcpHeader::GetClassData() const { return &_class_data_; }

void RcpHeader::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<RcpHeader *>(to)->MergeFrom(
      static_cast<const RcpHeader &>(from));
}


void RcpHeader::MergeFrom(const RcpHeader& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:mprpc.RcpHeader)
...
void RcpHeader::CopyFrom(const RcpHeader& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:mprpc.RcpHeader)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool RcpHeader::IsInitialized() const {
  return true;
}

void RcpHeader::InternalSwap(RcpHeader* other) {
  using std::swap;
...
::PROTOBUF_NAMESPACE_ID::Metadata RcpHeader::GetMetadata() const {
...
template<> PROTOBUF_NOINLINE ::mprpc::RcpHeader*
Arena::CreateMaybeMessage< ::mprpc::RcpHeader >(Arena* arena) {
  return Arena::CreateMessageInternal< ::mprpc::RcpHeader >(arena);
}
