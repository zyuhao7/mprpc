...
// .fixbug.ResultCode reuslt = 1;
inline bool LoginResponse::_internal_has_reuslt() const {
  return this != internal_default_instance() && reuslt_ != nullptr;
}
inline bool LoginResponse::has_reuslt() const {
  return _internal_has_reuslt();
}
inline void LoginResponse::clear_reuslt() {
  if (GetArenaForAllocation() == nullptr && reuslt_ != nullptr) {
    delete reuslt_;
  }
  reuslt_ = nullptr;
}
inline const ::fixbug::ResultCode& LoginResponse::_internal_reuslt() const {
...
inline const ::fixbug::ResultCode& LoginResponse::reuslt() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginResponse.reuslt)
  return _internal_reuslt();
}
inline void LoginResponse::unsafe_arena_set_allocated_reuslt(
    ::fixbug::ResultCode* reuslt) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.LoginResponse.reuslt)
}
inline ::fixbug::ResultCode* LoginResponse::release_reuslt() {
...
inline ::fixbug::ResultCode* LoginResponse::unsafe_arena_release_reuslt() {
  // @@protoc_insertion_point(field_release:fixbug.LoginResponse.reuslt)
  
  ::fixbug::ResultCode* temp = reuslt_;
  reuslt_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* LoginResponse::_internal_mutable_reuslt() {
...
inline ::fixbug::ResultCode* LoginResponse::mutable_reuslt() {
  ::fixbug::ResultCode* _msg = _internal_mutable_reuslt();
  // @@protoc_insertion_point(field_mutable:fixbug.LoginResponse.reuslt)
  return _msg;
}
inline void LoginResponse::set_allocated_reuslt(::fixbug::ResultCode* reuslt) {
  ...
  reuslt_ = reuslt;
  // @@protoc_insertion_point(field_set_allocated:fixbug.LoginResponse.reuslt)
}
